...
class Bootstrap
{
    ...
    //private $_controllerPath = '../libs/controllers/'; // Always include trailing slash
    private $_controllerPath = CONTROLLERS;
    //private $_modelPath = '../libs/models/'; // Always include trailing slash
